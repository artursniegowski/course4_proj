...
class Dev(Configuration):
    ...
    MIDDLEWARE = [
        ...
        # 'django.middleware.csrf.CsrfViewMiddleware',  # just so the porject wowrks in codio
        'django.contrib.auth.middleware.AuthenticationMiddleware',
        'django.contrib.messages.middleware.MessageMiddleware',
        # 'django.middleware.clickjacking.XFrameOptionsMiddleware', # just so the porject wowrks in codio
    ]
    ...
    # set up the loggin configurations
    LOGGING = {
        "version": 1,
    ...
    # updating django settings so it works with CommonPasswordValidator
